...
public class controllerSeguimientoEntregado implements Initializable {
    ...
    @FXML
    void NoCalificarVendedor(ActionEvent event) {

    }

    @FXML
    void calificarVendedor(ActionEvent event) throws Exception {
        ControladorRutas.launchCalificacion();
        Stage myStage = (Stage) this.SI.getScene().getWindow();
        myStage.close();
